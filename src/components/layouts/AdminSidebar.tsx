  ...
  return (
    <>
      ...
      >
        ...
        <div className="absolute top-0 left-0 w-full h-[500px] bg-gradient-to-b from-[#FFD700]/5 to-transparent pointer-events-none blur-3xl" />
            ...
            {menuItems.map(({ path, label, icon: Icon }) => {
              ...
              return (
                ...
                >
                  ...
                  <span
                    className={`relative z-10 text-[11px] tracking-[0.1em] uppercase ${isActive ? "font-black text-[#0038A8]" : "font-bold"}`}
                  >
                    {label}
                  </span>
