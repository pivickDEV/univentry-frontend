...
const BookAppointment = () => {
  ...
  // --- UI START (LIGHT MODE THEME) ---
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans selection:bg-[#FFD700]/30 selection:text-[#0038A8] relative overflow-x-hidden flex items-center justify-center p-4 lg:p-8">
      {/* --- HIGH-TECH ANIMATED BACKGROUND (Light Grid) --- */}
      <motion.div
        animate={{ backgroundPosition: ["0px 0px", "100px 100px"] }}
        transition={{ repeat: Infinity, duration: 20, ease: "linear" }}
        className="fixed inset-0 z-0 bg-[linear-gradient(to_right,#0038A808_1px,transparent_1px),linear-gradient(to_bottom,#0038A808_1px,transparent_1px)] bg-size-[3rem_3rem]"
      />
      <motion.div
      ...
      <motion.div
        ...
        className="absolute top-20 right-20 w-32 h-32 border border-[#FFD700]/40 rounded-full border-dashed hidden lg:block z-0"
      />
      <motion.div
        animate={{ y: [20, -20, 20], rotate: -360 }}
        transition={{ duration: 15, repeat: Infinity }}
        className="absolute bottom-20 left-20 w-48 h-48 border border-[#0038A8]/20 rounded-full border-dotted hidden lg:block z-0"
      />
      ...
      <div className="w-full max-w-300 relative z-10 grid lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        >
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-white/60 backdrop-blur-md border border-white text-[#0038A8] text-[10px] font-black uppercase tracking-widest mb-6 shadow-sm mx-auto lg:mx-0"
          >
            <FiShield className="text-[#FFD700] text-lg animate-pulse" />{" "}
            Official RTU Node
          </motion.div>
          <motion.h1
            variants={itemVariants}
            className="text-5xl lg:text-7xl font-black tracking-tighter text-[#0038A8] mb-4 uppercase leading-none"
          >
          ...
          <motion.p
            variants={itemVariants}
            className="text-slate-500 text-xs lg:text-sm font-bold uppercase tracking-[0.3em] leading-relaxed max-w-md mx-auto lg:mx-0"
          >
          ...
          <motion.div
            variants={itemVariants}
            className="mt-10 p-5 rounded-2xl bg-slate-900 border border-slate-800 shadow-xl hidden lg:block max-w-sm"
          >
            ...
            <p className="text-[10px] font-mono text-emerald-600 opacity-80 leading-relaxed">
              &gt; SYSTEM_READY
              <br />
              &gt; AWAITING_HANDSHAKE
              <br />
        ...
        <motion.div
          ...
          className="lg:col-span-7 w-full bg-white/90 backdrop-blur-xl rounded-[2.5rem] md:rounded-[3rem] shadow-[0_20px_60px_-15px_rgba(0,56,168,0.15)] overflow-hidden flex flex-col relative text-slate-800 border border-white min-h-150"
        >
          {/* STEPPER */}
          {step < 4 && (
          ...
          <div className="p-6 md:p-8 lg:p-12 flex-1 flex flex-col justify-center">
            ...
            <AnimatePresence mode="wait">
              ...
              {step === 2 && (
                ...
                >
                  ...
                  >
                    ...
                    >
                      <div className="bg-slate-900 rounded-4xl p-5 border-4 border-slate-800 flex flex-col md:flex-row items-center justify-between gap-4 shadow-xl relative overflow-hidden">
                        ...
                        <div className="relative z-10 flex items-center gap-4 bg-black/40 px-5 py-2.5 rounded-xl border border-white/5">
                          {isValidating ? (
                ...
                >
                  ...
                  <div className="grid lg:grid-cols-2 gap-8 items-start">
                    ...
                    <div className="space-y-4">
                      <div className="relative aspect-4/3 bg-slate-900 rounded-4xl overflow-hidden shadow-2xl border-[6px] border-slate-800 group">
                        ...
                        {!faceScan ? (
                          <>
                            ...
                            />
                            <div className="absolute bottom-4 left-1/2 -translate-x-1/2 px-6 py-2.5 rounded-full text-[9px] font-black uppercase tracking-widest bg-black/60 backdrop-blur-md text-white border border-white/10 z-20 shadow-lg">
                              Align Face in Frame
                            </div>
                          </>
                        ) : (
                          <div className="relative h-full w-full">
                            ...
                            <div className="absolute inset-0 bg-[#0038A8]/60 flex flex-col items-center justify-center z-10 backdrop-blur-sm">
                              <motion.div
                                ...
                                animate={{ scale: 1 }}
                              >
                                <FiCheckCircle className="text-5xl text-[#FFD700] drop-shadow-[0_0_30px_rgba(255,215,0,1)] mb-4" />
                              </motion.div>
                    ...
                    <div className="space-y-5">
                      ...
                      {/* AI FORGERY TERMINAL */}
                      <div className="bg-[#050505] p-5 rounded-2xl border-4 border-slate-800 shadow-inner flex flex-col relative overflow-hidden">
              ...
              {step === 4 && (
                ...
                >
                  {/* 🔥 UPDATED: max-w-lg makes the card wider and more prominent on mobile */}
                  <div className="w-full max-w-lg mx-auto bg-white rounded-[2.5rem] shadow-[0_20px_80px_-15px_rgba(0,56,168,0.3)] border-[6px] border-slate-50 overflow-hidden relative">
                    {/* Header */}
                    <div className="bg-[#0038A8] pt-12 pb-12 px-6 sm:px-10 text-center relative overflow-hidden">
                      ...
                      <motion.div
                        ...
                        className="w-16 h-16 sm:w-20 sm:h-20 bg-white/10 rounded-full flex items-center justify-center mx-auto mb-4 border-2 border-white/20 backdrop-blur-sm text-[#FFD700] relative z-10 shadow-[0_0_30px_rgba(0,56,168,0.8)]"
                      >
                        <FiCheck
                      ...
                      <h2 className="text-white font-black text-2xl sm:text-3xl uppercase tracking-widest leading-tight relative z-10">
                        Clearance Granted
                      </h2>
                      <p className="text-blue-200 text-[10px] sm:text-xs font-black uppercase tracking-[0.4em] mt-2 relative z-10">
